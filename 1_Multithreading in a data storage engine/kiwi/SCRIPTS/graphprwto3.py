...
file0 = open('teliko3/timingPerc1000.txt', 'r')
file1 = open('teliko3/timingPerc10000.txt', 'r')
file2 = open('teliko3/timingPerc100000.txt', 'r')
file3 = open('teliko3/timingPerc1000000.txt', 'r')
...
plt.title('writeread with percentages')
plt.xlabel('count')
plt.ylabel('time (sec)')
#plt.xticks(x)
