...
file0 = open('teliko2/timingOldVSNew1000.txt', 'r')
file1 = open('teliko2/timingOldVSNew10000.txt', 'r')
file2 = open('teliko2/timingOldVSNew100000.txt', 'r')
file3 = open('teliko2/timingOldVSNew1000000.txt', 'r')
...
plt.grid()
plt.semilogx(x,x_0thread,label="write")
plt.semilogx(x,x_1thread,label="read")
plt.semilogx(x,x_2thread,label="writeread")
