...
file0 = open('teliko4/timingRand1000.txt', 'r')
file1 = open('teliko4/timingRand10000.txt', 'r')
file2 = open('teliko4/timingRand100000.txt', 'r')
file3 = open('teliko4/timingRand1000000.txt', 'r')
...
plt.grid()
plt.semilogx(x,x_0thread,label="Random")
plt.semilogx(x,x_1thread,label="Non Random")
#plt.semilogx(x,x_2thread,label="4 thread")
#plt.semilogx(x,x_4thread,label="10 thread")
plt.title('Random vs Non Random')
plt.xlabel('count')
plt.ylabel('time (sec)')
#plt.xticks(x)
